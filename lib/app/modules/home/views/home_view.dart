...
class Fund4MeScreen extends StatefulWidget {
  @override
  _Fund4MeScreenState createState() => _Fund4MeScreenState();
}

class _Fund4MeScreenState extends State<Fund4MeScreen> {
      ...
      child: Column(
        ...
        children: [
          ...
          Row(
            ...
            children: [
              Icon(Icons.circle,
                  size: screenWidth * 0.025, color: Colors.white70),
              SizedBox(width: screenWidth * 0.02),
              Icon(Icons.circle,
                  size: screenWidth * 0.025, color: Colors.white38),
            ],
          ),
          SizedBox(height: screenHeight * 0.02),
        ],
